...
class TestEndToEnd:
    ...
    def test_frechet_product(
        ...
        assert_close(
            ...
            analytical_grad_embeddings,
            rtol=1e-4,
            msg="rotate_embeddings_backward gradient for embeddings doesn't match analytical gradient",
        )
        assert_close(
            grad_rope_encoding,
            analytical_grad_rope,
            rtol=1e-4,
            msg="rotate_embeddings_backward gradient for rope_encoding doesn't match analytical gradient",
        )
